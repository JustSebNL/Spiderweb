...
// DefaultConfig returns the default configuration for Spiderweb.
func DefaultConfig() *Config {
	return &Config{
		...
		Intake: IntakeConfig{
			...
			ForwardURL:           "",
			ForwardTimeout:       5,
			ForwardAllowChannels: FlexibleStringSlice{},
			ForwardDenyChannels:  FlexibleStringSlice{},
			ForwardAllowServices: FlexibleStringSlice{},
			ForwardDenyServices:  FlexibleStringSlice{},
			CheapCognition: CheapCognitionConfig{
				Enabled:        false,
				Runtime:        "auto",
		...
		Trigger: TriggerConfig{
			Enabled:   false,
			AutoStart: true,
			Workdir:   "~/.spiderweb/trigger",
			PIDFile:   "~/.spiderweb/trigger/trigger.pid",
			LogFile:   "~/.spiderweb/trigger/trigger.log",
			Host:      "127.0.0.1",
			Port:      3030,
		},
		Maintenance: MaintenanceConfig{
			...
			IntervalHours:         12,
			AutoRemediate:         true,
			HealthFile:            "~/.spiderweb/runtime-health.json",
			BudgetPercent:         5,
