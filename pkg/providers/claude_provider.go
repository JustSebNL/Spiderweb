...
import (
	...
	anthropicprovider "github.com/JustSebNL/Spiderweb/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: sweb auth login --provider anthropic")
		}
